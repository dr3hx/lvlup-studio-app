...
export function getMenuList(pathname: string, t: any): Group[] {
  return [
    {
      groupLabel: t("marketing_dashboard"),
      id: "marketing",
      menus: [
        {
          id: "analytics",
          ...
          submenus: [
            ...
            },
            {
              ...
              label: t("website_analytics"),
              active: pathname === "/analytics/website",
              icon: "heroicons:globe-alt",
              children: [],
            },
            {
              href: "/analytics/campaigns",
              label: t("campaign_performance"),
        ...
        },
        {
          ...
          href: "/ads",
          label: t("ads"),
          active: pathname.includes("/ads"),
          icon: "heroicons:megaphone",
          submenus: [
            {
              href: "/ads/campaigns",
              label: t("active_campaigns"),
              active: pathname === "/ads/campaigns",
              icon: "heroicons:presentation-chart-line",
              children: [],
            },
            {
              href: "/ads/performance",
              label: t("performance_analytics"),
              active: pathname === "/ads/performance",
        ...
        },
        {
          ...
          active: pathname.includes("/social-media"),
          icon: "heroicons:share",
          submenus: [
            {
              href: "/social-media/calendar",
              label: t("content_calendar"),
              active: pathname === "/social-media/calendar",
              icon: "heroicons:calendar-days",
              children: [],
            },
            {
              href: "/social-media/analytics",
              label: t("engagement_metrics"),
            ...
            },
            {
              ...
              label: t("connected_platforms"),
              active: pathname === "/social-media/platforms",
              icon: "heroicons:link",
              children: [],
            },
          ],
        },
        {
          ...
          href: "/creative",
          label: t("creative_ai"),
          active: pathname.includes("/creative"),
          icon: "heroicons:sparkles",
          submenus: [
            {
              href: "/creative/content",
              label: t("content_generation"),
              active: pathname === "/creative/content",
              icon: "heroicons:document-text",
              children: [],
            },
            {
              href: "/creative/images",
              label: t("image_creation"),
              active: pathname === "/creative/images",
              icon: "heroicons:photo",
              children: [],
            },
            {
              href: "/creative/library",
              label: t("content_library"),
              active: pathname === "/creative/library",
